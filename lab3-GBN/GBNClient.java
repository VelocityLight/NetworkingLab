...
public class GBNClient {
	...
	public static void main(String args[]) throws Exception {
		...
		for (int k = 0; k < 5; k++) {
			...
			DatagramPacket sendPacket = new DatagramPacket(sendData,sendData.length, receiverIp, receiverPort);
			clientSocket.send(sendPacket);
			ActionListener taskPerformer = new myActionListener(clientSocket,sendPacket, k);
